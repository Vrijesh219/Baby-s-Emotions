...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _handleParentSubmit() async {
    ...
    final userData = {
      ...
      'parentPhone': _parentNumberController.text,
      ...
      'relationship': selectedRelation ?? 'Parent',
  ...
  void _handleChildSubmit() async {
    ...
    // Navigate to dashboard with user data
    final userData = {
      'parentName': _childParentNameController.text,
      'parentPhone': _childParentNumberController.text,
      'parentPassword': _childParentPasswordController.text,
      'userType': selectedUserType ?? 'child',
    };
